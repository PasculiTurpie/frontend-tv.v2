...
const RegisterSchema = Yup.object().shape({
  ...
  email: Yup.string().email("Debe ser un correo válido").required("Campo obligatorio"),
  password: Yup.string()
    ...
    .matches(/[@$!%*?&]/, "Debe tener al menos un símbolo especial (@$!%*?&)"),
            ...
            <div className="container-form-brother">
              <Form className="form">
                ...
                <div className="form__group">
                  ...
                  <Field className="form__group-input" type="text" name="username" id="username" />
                  {errors.username && touched.username && (
                    <div className="form__group-error">{errors.username}</div>
                  )}
                </div>
                ...
                <div className="form__group">
                  ...
                  <Field className="form__group-input" type="email" name="email" id="email" />
                ...
                <div className="form__group" style={{ position: "relative" }}>
                  ...
                  {errors.confirmPassword && touched.confirmPassword && (
                    <div className="form__group-error">{errors.confirmPassword}</div>
                  )}
                </div>
              ...
              <div style={{ marginTop: "10px" }}>
                ...
                <ul style={{ listStyle: "none", paddingLeft: 0 }}>
                  ...
                  <li style={{ color: rules.hasUpperCase ? "green" : "red" }}>
                    {rules.hasUpperCase ? "✔" : "✖"} Una letra mayúscula
                  </li>
                  <li style={{ color: rules.hasLowerCase ? "green" : "red" }}>
                    {rules.hasLowerCase ? "✔" : "✖"} Una letra minúscula
                  </li>
                  <li style={{ color: rules.hasNumber ? "green" : "red" }}>
                    {rules.hasNumber ? "✔" : "✖"} Un número
                  </li>
                  <li style={{ color: rules.hasSpecialChar ? "green" : "red" }}>
